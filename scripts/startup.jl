...
pkgs = unique( [  
    ...
    "JLD2", "LibGEOS", "Graphs", "DelaunayTriangulation", "ArchGDAL",
    "Random", "Turing", "Distributions", "Statistics", "MCMCChains", "DataFrames",
    "LinearAlgebra", "Clustering", "StatsBase", "LogExpFunctions", "StatsFuns",
    ...
    #"ParameterHandling",  
    # "ArviZ", 
    "Graphs", "PlotThemes", "Colors", "ColorSchemes", "Plots", "StatsPlots", "BenchmarkTools",
    ...
    "Bijectors", "DynamicPPL", "AdvancedVI", "Optimisers", "Optim",
